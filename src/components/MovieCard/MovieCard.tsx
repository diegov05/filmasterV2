...
const MovieCard: FC<MovieCardProps> = (props) => {
    ...
    return (
        <div onMouseEnter={handleToggleOverlay} onMouseLeave={handleToggleOverlay} className='relative w-48 md:max-4xl:w-64 h-full flex flex-col justify-between items-start rounded-2xl shadow-lg shadow-zinc-600'>
